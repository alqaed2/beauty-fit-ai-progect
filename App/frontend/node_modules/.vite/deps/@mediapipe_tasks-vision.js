...
// node_modules/.pnpm/@mediapipe+tasks-vision@0.10.34/node_modules/@mediapipe/tasks-vision/vision_bundle.mjs
...
var Lr = class {
  ...
  j() {
    ...
    if (B && r2 && null != ((_a2 = e2[r2]) == null ? void 0 : _a2[n2]) && U(W, 3), e2 = t2.g, $ && H && void 0 === $ && (r2 = (n2 = this.v)[H]) && (r2 = r2.da)) try {
      r2(n2, e2, Le);
    } catch (t3) {
      u(t3);
    }
...
function jr(t2, e2, n2, r2) {
  ...
  for (c2 = 1; void 0 !== s2; ) {
    ...
    var h2 = void 0;
    if (s2 instanceof Rr ? t3 = s2 : (t3 = Mr, o2--), t3 == null ? void 0 : t3.l) {
      s2 = r2[++o2], h2 = r2;
      var u2 = o2;
...
function Vo(t2) {
  const e2 = { classifications: vn(t2, Rs, 1).map((t3) => {
    var _a2;
    return jo(((_a2 = yn(t3, gs, 4)) == null ? void 0 : _a2.g()) ?? [], kn(t3, 2) ?? 0, le($e(t3, 3)) ?? "");
  }) };
...
function Xo(t2) {
  ...
  if ((e2 = (_a2 = yn(t2, Es, 4)) == null ? void 0 : _a2.l()) && (s2.boundingBox = { originX: kn(e2, 1, qe) ?? 0, originY: kn(e2, 2, qe) ?? 0, width: kn(e2, 3, qe) ?? 0, height: kn(e2, 4, qe) ?? 0, angle: 0 }), (_b = yn(t2, Es, 4)) == null ? void 0 : _b.g().length) for (const e3 of yn(t2, Es, 4).g()) s2.keypoints.push({ x: $e(e3, 1, void 0, qe, $t) ?? 0, y: $e(e3, 2, void 0, qe, $t) ?? 0, score: $e(e3, 4, void 0, qe, $t) ?? 0, label: le($e(e3, 3, void 0, qe)) ?? "" });
  return s2;
}
function Ho(t2) {
  const e2 = [];
...
var pa = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c2 = yn(this.baseOptions, Vs, 1)) == null ? void 0 : _c2.g()) || ((_d = yn(this.baseOptions, Vs, 1)) == null ? void 0 : _d.l()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath))) throw Error("Either baseOptions.modelAssetPath or baseOptions.modelAssetBuffer must be set");
      if (function(t3, e4) {
...
var Fc = class extends dc {
  ...
  o(t2) {
    ...
    if (xn(this.A, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Ln(this.A, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Ln(this.u, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Ln(this.D, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new to(), n2 = e2, r2 = Bo(t2.cannedGesturesClassifierOptions, (_a2 = yn(this.h, to, 3)) == null ? void 0 : _a2.l());
      wn(n2, 0, 2, r2), wn(this.h, 0, 3, e2);
    } else void 0 === t2.cannedGesturesClassifierOptions && ((_b = yn(this.h, to, 3)) == null ? void 0 : _b.g());
    return t2.customGesturesClassifierOptions ? (wn(n2 = e2 = new to(), 0, 2, r2 = Bo(t2.customGesturesClassifierOptions, (_c2 = yn(this.h, to, 4)) == null ? void 0 : _c2.l())), wn(this.h, 0, 4, e2)) : void 0 === t2.customGesturesClassifierOptions && ((_d = yn(this.h, to, 4)) == null ? void 0 : _d.g()), this.l(t2);
  }
  Ha(t2, e2) {
    ...
    Rn(n2, 2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), ns(n2, "IMAGE:image_in"), ns(n2, "NORM_RECT:norm_rect"), rs(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), cs(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = Os(t3), this.embeddings = function(t4) {
        return { embeddings: vn(t4, Ps, 1).map((t5) => {
          ...
          var n3 = t5.v;
          return void 0 !== mn(n3, 0 | n3[Q], Fs, ln(t5, 1)) ? (t5 = en(t5 = yn(t5, Fs, ln(t5, 1), void 0), 1, $t, tn()), e4.floatEmbedding = t5.slice()) : (n3 = new Uint8Array(0), e4.quantizedEmbedding = ((_b = (_a2 = yn(t5, Ms, ln(t5, 2), void 0)) == null ? void 0 : _a2.na()) == null ? void 0 : _b.h()) ?? n3), e4;
...
function Vc(t2) {
  ...
  1 === e2.length && (((_b = (_a2 = yn(e2[0], Qi, 7)) == null ? void 0 : _a2.j()) == null ? void 0 : _b.g()) ?? /* @__PURE__ */ new Map()).forEach((e3, n2) => {
